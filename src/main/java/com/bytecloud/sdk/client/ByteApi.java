...
public interface ByteApi {
     ...
     * @return 地址
     */
    Address createAddress(String mainCoinType)  throws ByteException;
     ...
     * @return 地址
     */
    Address createAddress(String mainCoinType, String alias, String walletId)  throws ByteException;
     ...
     * @return 地址
     */
    Address createAddress(String mainCoinType, String alias, String walletId, String callUrl) throws ByteException;
